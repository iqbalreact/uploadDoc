...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title">Hi, Welcome<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
    ...
    <div class="panel-body">
        {{-- <h6 class="text-semibold">Sistem Pendukung Keputusan Menggunakan Metode Weight Product</h6>
