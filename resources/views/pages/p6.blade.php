...
@section('title')
    <title>Dashboard - Peningkatan Kualitas Layanan Publik</title>
@endsection
...
<div class="panel panel-flat">
    <div class="panel-heading"> 
        <h5 class="panel-title">Peningkatan Kualitas Layanan Publik <a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
